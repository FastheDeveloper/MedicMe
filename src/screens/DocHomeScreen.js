...
import MenuScreen from './DocTabs/MenuScreen';
import InfoScreen from './DocTabs/InfoScreen'
import ReviewScreen from './DocTabs/ReviewScreen'
import GalleryScreen from './DocTabs/GalleryScreen'
import Route1 from './MenuTabs';

const SCREEN_WIDTH=Dimensions.get('window').width
const initialLayout = SCREEN_WIDTH;

const DocHomeScreen = ({navigation,route}) => {
...
const menuPressed=()=>{
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
      <View>
         <DocHeader id={id} navigation={navigation} />
         {restaurantsData[id].discount &&
         <View style={styles.view1}>
           <Text style={styles.text1}>
            GET {restaurantsData[id].discount}% OFF ON ALL APPOINTMENTS
            </Text>
         </View>
         }
         <View style={styles.view2}>
            <View style={styles.view3}>
              ...
              <View style={styles.view4}>
                ...
                size={15}
                />
                <Text style={styles.text6}>{restaurantsData[id].farAway} miles away</Text>
              </View>
            </View>
            <View style={styles.view5}>
              <Text style={styles.text6}>Book</Text>
            ...
            <View style={styles.view8}>
              <Text  style={styles.text6}>Home Visit</Text>
