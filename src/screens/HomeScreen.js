    ...
    <View style={styles.container}>
      ...
      <ScrollView bounces={false}>
        <View style={styles.home}>
          <Text style ={styles.text1}>Medicare at your convinience</Text>
        <View style={styles.view1}>
          <View style={styles.view8}>
            <Text style={styles.text2}> Search  registered practisioners.</Text>
            <TouchableOpacity onPress={()=>{navigation.navigate("DocMapScreen",{state:0})}}>
              <View style={styles.button1}>
                <Text style ={styles.button1Text}>Find a Doctor</Text>
              </View>
            </TouchableOpacity>
          </View>
          <View>
        ...
        <View>
          ...
          <View style={styles.view3}>
            <Text style={styles.text3}>Search for practitioner</Text>
          ...
          <View style={styles.view5}>
              <View style={styles.view6}>
                  ...
                  <View>
                  <Text style={{fontSize:18,color:colors.black}}>35 Gbadamosi rd </Text>
                  <Text style={{color:colors.grey3}}> Challenge orita road. </Text>
                  </View>
              </View>
              <View>
                    <Icon type="material-community"
          ...
          <View style={{alignItems:"center",justifyContent:"center"}}>
                ...
                initialRegion={{...docsAround[0],latitudeDelta:0.008,longitudeDelta:0.008}}
                >
                    {
                      docsAround.map((item,index)=>
