...
// const GOOGLE_API='AIzaSyBdsq_GD9OBSVzdg7l8BPsLrTQNG0GCXd0'
         ...
         <MapView
                ...
                >
                  {this.props.userOrigin.latitude != null &&
                      <MapView.Marker coordinate={this.props.userOrigin} 
                      anchor= {{x:0.5,y:0.5}}>
                      <Image
                  ...
                  {this.props.userDestination.latitude != null &&
                      <MapView.Marker coordinate={this.props.userDestination} 
                      anchor= {{x:0.5,y:0.5}}>
                      <Image
                      source={require('../../assets/location.png')}
                  ...
                  }
                  {
                    ...
                    apikey='AIzaSyAO8NO0EzaVzqojFw_LSWRcThnzbeaq8AI'
                    strokeWidth={3}
                    strokeColor="black"
                    />
                  }
